...
namespace Kheti.Migrations
{
    ...
    [Migration("20240216175335_AddQueryCommentNavigationInFormProperty")]
    partial class AddQueryCommentNavigationInFormProperty
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Kheti.Models.QueryComment", b =>
                {
                    ...
                    b.HasIndex("QueryFormId1")
                        .IsUnique()
                        .HasFilter("[QueryFormId1] IS NOT NULL");
            ...
            modelBuilder.Entity("Kheti.Models.QueryComment", b =>
                {
                    ...
                    b.HasOne("Kheti.Models.QueryForm", null)
                        .WithOne("QueryComment")
                        .HasForeignKey("Kheti.Models.QueryComment", "QueryFormId1");
